  ...
  <section class="w-full bg-gradient-to-b from-gray-700 to-gray-600">
    <section class="container-section pb-12">
      <HeaderSection
        ...
        title="Runtutan Acara"
      ></HeaderSection>
      <Card>
        <template v-slot:body>
          <div
            class="bg-gray-900 px-6 py-8 text-center text-sm font-medium"
            v-for="(timeline, index) in timelines"
            :key="index"
          >
            <section data-aos="fade-up">
              <h1 class="text-xl satisfy-font text-amber-400">
                {{ timeline.title }}
              </h1>
              ...
              <decoration
                class="w-2/12 mx-auto my-2 fill-amber-500"
              ></decoration>
              <p class="text-amber-500">{{ timeline.location }}</p>
              <p class="text-gray-200">{{ timeline.address }}</p>
              <a class="btn" target=”_blank” href="https://www.google.com/maps?q=-6.9594202,110.4374539&z=17&hl=en">
                <i class="fa-solid fa-map"></i>
                Lihat Peta
              </a>
              <decoration
                class="w-2/12 mx-auto my-2 fill-amber-500 rotate-180"
              ></decoration>
            </section>
          </div>
        </template>
          ...
          <section class="bg-gray-900">
            ...
            <div class="px-6 pt-5 pb-8 text-center">
              <p class="text-sm text-gray-100">
                Konfirmasi kehadiran anda pada buku tamu
              </p>
            ...
            <img src="@/assets/images/couples.jpeg" alt="" />
          </section>
        </template>
      </Card>
    </section>
